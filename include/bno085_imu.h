...
namespace imu
{
    ...
    struct bno85
    {
        ...
        bool init_i2c_hal()
        {
            ...
            { // sh2.h line 60
                ...
                std::cout << "Version: " << _prodIds.entry[n].swVersionMajor << "." << _prodIds.entry[n].swVersionMinor << "." << _prodIds.entry[n].swVersionPatch << std::endl;
        ...
        bool hasReset(void)
        {
            ...
            if (x)
                std::cout << "imu was reset" << std::endl;
            return x;
        }
    };
    ...
    inline void sensorHandler(void *cookie, sh2_SensorEvent_t *event)
    {
        ...
        case SH2_ROTATION_VECTOR:
            std::cout << "{" << "\"i\":" << sensor_value.un.rotationVector.i << ", " << "\"j\":" << sensor_value.un.rotationVector.j << ", " << "\"k\":" << sensor_value.un.rotationVector.k << ", " << "\"r\":" << sensor_value.un.rotationVector.real << "}\n";
            break;
